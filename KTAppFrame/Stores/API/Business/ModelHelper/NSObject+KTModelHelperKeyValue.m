//
//  NSObject+KTModelHelperKeyValue.m
...
@implementation NSObject (KTModelHelperKeyValue)
#pragma mark - 公共方法
#pragma mark - 字典转模型
/**
 *  通过JSON数据来创建一个模型
...
+ (instancetype)objectWithKeyValues:(NSDictionary *)keyValues
{
    ...
    MJAssert2([keyValues isKindOfClass:[NSDictionary class]], desc, nil);desc = nil;
...
{
    NSString *desc = [NSString stringWithFormat:@"keyValues is not a NSDictionary - keyValues参数不是一个字典, keyValues is a %@ - keyValues参数是一个%@", keyValues.class, keyValues.class];
    MJAssert2([keyValues isKindOfClass:[NSDictionary class]], desc, );desc = nil;
...
+ (NSArray *)keyValuesArrayWithObjectArray:(NSArray *)objectArray
{
    ...
    MJAssert2([objectArray isKindOfClass:[NSArray class]], desc, nil);desc = nil;
...
+ (NSArray *)objectArrayWithKeyValuesArray:(NSArray *)keyValuesArray
{
    ...
    MJAssert2([keyValuesArray isKindOfClass:[NSArray class]], desc, nil);desc = nil;
